...
# Package Groups
# -----------------------
CORE_PACKAGES=(hyprland hyprpaper hypridle hyprlock hyprsunset hyprpolkitagent xhost wl-clipboard waybar socat eww wofi grim slurp mako brightnessctl clipse kitty neovim tmux zsh btop yazi 7zip pulsemixer)
